  ...
  methods: {
    getPosts: function getPosts(page) {
      ...
      axios.get('/api/posts', {
        ...
        _this.posts = response.results.data;
        _this.currentPage = response.results.data.current_page;
        _this.lastPage = response.results.data.last_page;
      });
    }
  }
});
...
var render = function render() {
  ...
  return _c("div", [_c("nav", {
    ...
    "class": _vm.link in _vm.linksHeader
...
module.exports = __webpack_require__(/*! C:\Users\simon\Desktop\Boolean\laravel-api\resources\js\front.js */"./resources/js/front.js");
